...
const products = [
  {
    ...
    pdfUrl: "/backend/product-data/alignment/1/Acoem_AT-300.pdf",
    imageUrl: "/backend/product-data/alignment/1/Acoem_AT-300.png"
  },
  {
    category: "Alignment",
    name: "Acoem_AT-400",
    ...
    pdfUrl: "/backend/product-data/alignment/2/Acoem_AT-400.pdf",
    imageUrl: "/backend/product-data/alignment/2/Acoem_AT-400.png"
  },
  {
    category: "Alignment",
    name: "Acoem_AT-400",
  ...
  
  {
    ...
    imageUrl: "/backend/product-data/thermal-camera/1/Flir-E8-XT-NEW-MODEL-Thermal-Imaging-Camera.png"
  },
  {
    category: "Thermal Camera",
    name: "Flir T530",
    ...
    imageUrl: "/backend/product-data/thermal-camera/2/Flir_T530-1500x1500.jpg"
  }
];
